...
export const TermsAndCondition = () => {
  return (
    <div className="terms">
      ...
      <p>
        Welcome to <Link to="/">zevocorp.in</Link>!
      </p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Zevo Corporation's Website, located at{" "}
        <Link to="/">zevocorp.in</Link>.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use <Link to="/">zevocorp.in</Link> if
      ...
      <p>
        ...
        <Link to="/">zevocorp.in</Link>, you agreed to use cookies in agreement
        with the Zevo Corporation's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Zevo Corporation and/or its licensors own the
        intellectual property rights for all material on{" "}
        <Link to="/">zevocorp.in</Link>. All intellectual property rights are
        reserved. You may access this from
        <Link to="/">zevocorp.in</Link> for your own personal use subjected to
      ...
      <ul>
        <li>
          Republish material from <Link to="/">zevocorp.in</Link>
        </li>
        <li>
        ...
        <li>
          Redistribute content from <Link to="/">zevocorp.in</Link>
        </li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Zevo
        Corporation does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Zevo Corporation,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Zevo Corporation
      ...
      <p>
        Zevo Corporation reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Zevo Corporation a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Zevo Corporation; and (d) the
      ...
      <p>
        ...
        e-mail to Zevo Corporation. Please include your name, your organization
      ...
      <p>
        No use of Zevo Corporation's logo or other artwork will be allowed for
...
export const Disclaimer = () => {
  return (
    <div className="terms">
      ...
      1.41 GB of 30 GB used Program Policies Powered by Google Last account
      activity: 7 minutes ago Details
    </div>
  );
};
